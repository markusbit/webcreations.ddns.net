...
<body>
    ...
    <section id="home" class="home">
        ...
        <h2>with Brandstetter Web Creations</h2>
        ...
        <div class="row">
            <div class="content">
                ...
                <p>Ours is a team of creatives that is brainstorming on great ideas,<b> all. the. time.</b><br>
                    With our skills put together, you get an ensemble capable of doing anything and everything your
                    brand needs.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="section-head col-sm-12" id="service">
                    <h1>Our Services</h1>
                    <p>We help you to build high-quality digital solutions and products as well as deliver a wide range
                        of related professional services. We are providing world-class service to our clients.
                    </p>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_one"><i class="fa fa-laptop"></i></span>
                        <h6>Web App Development</h6>
                        <p>Our Custom Web Development Services Include Both Front-End And Back-End Development. Whether
                            It Is Enhancing An Existing App Or Architecting An Enterprise App, Our Developers Are Up For
                            The Challenge.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_two"><i class="fa fa-android"></i></span>
                        ...
                        <p>Is your website due for a makeover? We're here to modernize your digital identity, from
                            revamping the design to ensuring regular content updates and performance optimization.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_three"><i class="fa fa-magic"></i></span>
                        <h6>Digital Marketing</h6>
                        <p>The digital marketing services that we provide have their own set of charms. By taking our
                            digital marketing services, our clients will be able to increase visibility and engage with
                            their customers at the online platform.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_one"><i class="fa fa-address-book"></i></span>
                        <h6>Search Engine Optimization (SEO)</h6>
                        <p>Our SEO services cover both on-page and off-page optimization, including keyword research and
                            comprehensive SEO audits to help you rank higher in search results.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="item"> <span class="icon feature_box_col_two"><i class="fa fa-globe"></i></span>
                        <h6>Web Hosting and Domain Services</h6>
                        <p>We offer dependable hosting setup, domain registration, and SSL certificate installation to ensure your website is secure and accessible.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="accordion-container">
                <div class="accordion">
                    ...
                    <div class="accordion-body">
                        <p>To get a better idea of the cost of what you want to build, give us a quick phone call. We’ll
                ...
                <div class="accordion">
                    ...
                    <div class="accordion-body">
                        <p>The process begins when you contact us with your requirements. We analyze your requirements
                            and respond to you.
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact" style="font-size: 1.5rem;">
                        ...
                        <p>
                            ...
                            2020 Hollabrunn<br>
                            Austria <br>
                            <strong>Phone:</strong> +43 6766 281958<br>
                            <strong>Email:</strong> bwebcreations@gmail.com<br>
                        </p>
                    ...
                    <div class="col-lg-3 col-md-6 footer-newsletter">
                        <h4>Subscription</h4>
                        <p>With Our Skills Put Together, You Get An Ensemble Capable Of Doing Anything And Everything
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 copyright" style="color: #fff; font-size: 1.3rem;">
                    Copyright &copy; 2023 Brandstetter Web Creations. All Rights Reserved.
                </div>
            </div>
        </div>
    </div>
